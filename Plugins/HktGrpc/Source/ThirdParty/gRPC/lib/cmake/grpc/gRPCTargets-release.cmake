...
list(APPEND _cmake_import_check_files_for_gRPC::zlibstatic "${_IMPORT_PREFIX}/lib/zlibstatic.lib" )
...
set_target_properties(gRPC::upb_hash_lib PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/upb_hash_lib.lib"
  )

list(APPEND _cmake_import_check_targets gRPC::upb_hash_lib )
list(APPEND _cmake_import_check_files_for_gRPC::upb_hash_lib "${_IMPORT_PREFIX}/lib/upb_hash_lib.lib" )
...
set_target_properties(gRPC::upb_lex_lib PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/upb_lex_lib.lib"
  )

list(APPEND _cmake_import_check_targets gRPC::upb_lex_lib )
list(APPEND _cmake_import_check_files_for_gRPC::upb_lex_lib "${_IMPORT_PREFIX}/lib/upb_lex_lib.lib" )
...
set_target_properties(gRPC::upb_mini_table_lib PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/upb_mini_table_lib.lib"
  )

list(APPEND _cmake_import_check_targets gRPC::upb_mini_table_lib )
list(APPEND _cmake_import_check_files_for_gRPC::upb_mini_table_lib "${_IMPORT_PREFIX}/lib/upb_mini_table_lib.lib" )
...
set_target_properties(gRPC::upb_reflection_lib PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/upb_reflection_lib.lib"
  )

list(APPEND _cmake_import_check_targets gRPC::upb_reflection_lib )
list(APPEND _cmake_import_check_files_for_gRPC::upb_reflection_lib "${_IMPORT_PREFIX}/lib/upb_reflection_lib.lib" )
...
set_target_properties(gRPC::utf8_range_lib PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/utf8_range_lib.lib"
  )
