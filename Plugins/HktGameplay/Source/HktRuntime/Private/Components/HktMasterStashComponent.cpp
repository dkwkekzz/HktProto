...
bool UHktMasterStashComponent::TryGetPosition(FHktEntityId Entity, FVector& OutPosition) const
{
    if (!IsValidEntity(Entity))
    {
        return false;
...
void UHktMasterStashComponent::SetPosition(FHktEntityId Entity, const FVector& Position)
{
    if (!IsValidEntity(Entity))
    {
        return;
