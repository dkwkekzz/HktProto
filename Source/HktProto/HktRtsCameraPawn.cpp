...
void AHktRtsCameraPawn::BeginPlay()
{
	...
	if (UWorld* World = GetWorld())
	{
		...
		{
			EventSubsystem->OnMinimapCameraMoveRequest.AddUObject(this, &AHktRtsCameraPawn::OnMoveCameraToMinimapLocation);
		}
	}
}
...
void AHktRtsCameraPawn::HandleZoom(const FInputActionValue& Value)
{
