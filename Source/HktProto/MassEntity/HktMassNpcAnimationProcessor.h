 ...
 */
UCLASS()
class HKTPROTO_API UHktMassNpcAnimationFragmentInitializer : public UMassObserverProcessor
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class HKTPROTO_API UHktMassNpcAnimationProcessor : public UMassProcessor
{
	GENERATED_BODY()
